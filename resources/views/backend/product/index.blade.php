        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <div class="box-tools pull-right">
                    {{-- <a href="{{ route('app.product.import') }}" class="btn btn-sm btn-info rounded-0"><i class="fa fa-upload fa-sm"></i> Import</a> --}}
                    <button type="button" class="btn btn-sm btn-primary rounded-0" onclick="showFormModal('New Product', 'Save')"><i class="fa fa-plus fa-sm"></i> Add Product</button>
                </div>
            </div>
            <div class="box-body">
...
@include('backend.product.update_or_store')
@endsection
@push('scripts')
    <script>
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{ route('app.product.update-or-store') }}";
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#store_or_update_form #pre_price').val(data.data.pre_price);
                        $('#store_or_update_form #price').val(data.data.price);
                        $('#store_or_update_form #quantity').val(data.data.quantity);
                        $('#store_or_update_form #weight').val(data.data.weight);
                        $('#store_or_update_form #available').val(data.data.available);
        ...
        $(document).on('click','.change_status', function(){
            ...
            var url = "{{ route('app.product.status-change') }}"
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url = "{{ route('app.product.delete') }}";
            delete_data(id,url,row,title);
        });
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{ route('app.product.bulk-delete') }}";
