...
@include('backend.user.update_or_store')
@endsection
@push('scripts')
    <script>
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#store_or_update_form #usertype').val(data.data.usertype);
                        $('#store_or_update_form #email').val(data.data.email);
                        $('#store_or_update_form #number').val(data.data.number);
                        $('#store_or_update_form #address').val(data.data.address);
